...
A 10-Q may restate its risk factors or state that nothing material has changed since the annual report. Of 1,211 ARK quarterly reports with a located Item 1A heading (90% of filings), 47% restate, 11% claim no material change but add updates, 39% refer the reader to the annual report and 3% disclose nothing. A restated section runs to a median of 27,137 words, a reference to 79; in annual reports Item 1A is 35% of all words. Because both measures are word shares, a company that stops restating scores lower without writing differently: across 81 such quarters by 36 companies, the uncertainty share falls 0.21 pp and the negative share 0.38 pp, while the share in the rest of the filing moves +0.05 and 0.00 pp. Figure 2 shows the two largest cases; Table 7 repeats each result on the same filings without Item 1A.
...
### Table 7. The same results on the whole filing and excluding Item 1A, identical filings
...
| Annual reports: Item 1A share of words, trend (pp a year)                       | 404       | +0.426         | 0.038   |                     |         |
...
| Quarterly reports: Item 1A share of words, trend (pp a year)                    | 1,211     | -1.214         | 0.036   |                     |         |
...
| Annual reports: Item 1A share of words, level (pp)                              | 682       | -7.989         | 0.006   |                     |        |
...
Believed: the difference between the portfolios is how much risk disclosure they print. QQQ annual reports carry 0.27 pp fewer negative and 0.20 pp fewer uncertainty words on the whole filing (p = 0.003, p < 0.001), and Item 1A takes 8.0 pp less of their words (30% against 35%); excluding the section the gaps are 0.051 pp (p = 0.383) and 0.008 pp (p = 0.786). ARK's annual-report trends are steeper: by 0.007 pp a year for uncertainty on the whole filing (p = 0.001) and by 0.034 pp a year for negative words outside Item 1A (p = 0.002). The whole-filing return association differs between the portfolios (+2.9 pp per standard deviation, p = 0.007) and not once Item 1A is removed (-1.0 pp, p = 0.450). In quarterly reports the volatility coefficients do not differ (p = 0.237, p = 0.522); in annual reports they differ on the whole filing (+10.0 pp per standard deviation, p = 0.002) and not excluding Item 1A (-0.7 pp, p = 0.863).

[Loughran, T., and B. McDonald, 2011, When is a liability not a liability? Textual analysis, dictionaries, and 10-Ks, Journal of Finance 66, 35-65.](https://doi.org/10.1111/j.1540-6261.2010.01625.x)

[Code, executed notebook, tests and the data workbook.](https://github.com/robynge/FRE-GY-7871A-Assignment1)
