...
The analysis was subsequently rerun with active dictionary flags only and extended through September 9, 2026. Codex separated the text, return and volatility samples to retain recent filings without filling unobserved future outcomes, added early-close handling, and regenerated mathematical notation and reports. The original 2021–2025 assignment window was recomputed separately. Review identified that treating negative year flags as active dictionary membership had retained ten removed negative words; the active-word rule corrects that mistake.
